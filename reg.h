...
#define B_AX_LED2_MODE_MASK GENMASK(18, 16)
#define LED_MODE_AON 0x1
#define LED_MODE_TRX_ON 0x2

#define R_AX_LED_CTRL 0x004E   /* byte-accessible only — not 4-byte aligned */
#define B_AX_LED_WL_EN BIT(5)
